    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500 mt-2">Sua gestão financeira simplificada</p>
        </div>
          ...
          <TabsContent value="login">
            <Card>
              ...
              <form onSubmit={handleLogin}>
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <a href="#" className="text-xs text-finsync-primary hover:underline">
                        Esqueceu a senha?
                      </a>
                    </div>
                    <Input 
                ...
                <CardFooter>
                  <Button type="submit" className="w-full bg-finsync-primary hover:bg-finsync-primary/90" disabled={isLoading}>
